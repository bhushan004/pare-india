import { BannerBg, NoVOCImg, RealwoodImg, SeamlessImg, WaveBannerWoodImg, WaveTitleImg } from '@/utils/assets'
      ...
      <div className="grid grid-cols-4 bg-red-base text-white md:h-screen md:grid-cols-3 md:items-center md:justify-center 2xl:-mx-40 2xl:h-[80vh]">
        ...
        <div className="col-span-3 pl-16 md:col-span-2 md:pl-0 md:pr-10 2xl:pr-40">
          ...
          <div className="col-span-2 py-10 pr-2 text-center font-montserrat text-sm font-medium text-white md:text-xl 2xl:text-2xl">
            ...
            panels offer a timeless and long-lasting solution for your decorative needs.
          </div>
          <div className="hidden grid-cols-3 gap-10 md:grid">
            <div className="flex flex-col items-center gap-5">
              <Image src={NoVOCImg} alt={'box'} width={82} height={82} className="h-[82px] rounded-full object-contain" />
            ...
            <div className="flex flex-col items-center gap-5">
              <Image src={RealwoodImg} alt={'box'} width={82} height={82} className="h-[82px] object-contain" />
            ...
            <div className="flex flex-col items-center gap-5">
              <Image src={SeamlessImg} alt={'box'} width={82} height={82} className="h-[82px] object-contain" />
        ...
        <div className="col-span-4 grid grid-cols-3 gap-3 px-3 py-5 md:hidden">
          <div className="flex flex-col items-center gap-5">
            <Image src={NoVOCImg} alt={'box'} width={50} height={50} className="h-[50px] rounded-full object-contain" />
          ...
          <div className="flex flex-col items-center gap-5">
            <Image src={RealwoodImg} alt={'box'} width={50} height={50} className="h-[50px] object-contain" />
          ...
          <div className="flex flex-col items-center gap-5">
            <Image src={SeamlessImg} alt={'box'} width={50} height={50} className="h-[50px] object-contain" />
